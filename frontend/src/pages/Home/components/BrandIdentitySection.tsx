...
const Feature = ({ icon: Icon, titleAr, titleEn, descAr, descEn, rtl }: FeatureProps) => (
  <div className="flex items-start gap-4">
    <div className="relative p-2.5 rounded-xl bg-slate-100 dark:bg-white/5 text-slate-500 dark:text-slate-300 group-hover:text-primary-500 border border-slate-200 dark:border-white/10 shadow-lg shadow-black/5 transition-all">
      <Icon size={22} />
    </div>
    <div>
            ...
            >
              ...
              >
                ...
                <span className="relative z-10 flex items-center justify-center gap-3 w-full">
                   ...
                   <div className="relative p-1.5 rounded-lg bg-white/20 backdrop-blur-md group-hover:rotate-12 transition-transform">
                      <Palette size={18} />
                   </div>
                </span>
              </Link>
