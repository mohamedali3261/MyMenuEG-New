...
export const ADMIN_TABS: AdminTabItem[] = [
  ...
  { id: 'marquee', labelAr: 'الشريط المتحرك', labelEn: 'Animated Strip', path: '/admin/marquee' },
  ...
  { id: 'reviews', labelAr: 'التقييمات', labelEn: 'Reviews', path: '/admin/reviews' },
  { id: 'messages', labelAr: 'رسائل التواصل', labelEn: 'Contact Messages', path: '/admin/messages' },
  { id: 'contact', labelAr: 'إعدادات التواصل', labelEn: 'Contact Settings', path: '/admin/contact' },
  { id: 'faq', labelAr: 'الأسئلة الشائعة', labelEn: 'FAQ Settings', path: '/admin/faq' },
  { id: 'payment', labelAr: 'إعدادات الدفع', labelEn: 'Payment Settings', path: '/admin/payment' },
  { id: 'shipping', labelAr: 'إعدادات الشحن', labelEn: 'Shipping Settings', path: '/admin/shipping' },
  { id: 'auth', labelAr: 'المصادقة (تسجيل الدخول)', labelEn: 'Auth (Login)', path: '/admin/auth' },
