 ...
 */
export const sendOrderConfirmationEmail = async (email, orderId, customerName, total, items) => {
 ...
 */
export const sendOrderStatusEmail = async (email, orderId, customerName, status, statusAr) => {
