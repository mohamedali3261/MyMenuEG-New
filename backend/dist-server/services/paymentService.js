...
const getAuthToken = async () => {
    try {
        const response = await resilientRequestOrThrow({
            service: 'paymob',
            method: 'POST',
 ...
 */
export const initializeFawryPayment = async (data) => {
    ...
    try {
        ...
        const result = await resilientRequestOrThrow({
            service: 'fawry',
            method: 'POST',
 ...
 */
export const verifyFawryCallback = (data) => {
...
export const initializeWalletPayment = async (data) => {
    ...
    try {
        ...
        const walletResponse = await resilientRequestOrThrow({
            service: 'paymob',
            method: 'POST',
